...
- Installer SHA-256: (recorded after build — see build log)
- Portable ZIP SHA-256: (recorded after build — see build log)
- App SHA-256: (recorded after build — see build log)
